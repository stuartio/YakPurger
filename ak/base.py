    ...
    def do(self, method, path, query, headers, body=None):
        ...
        with requests.Session() as session:
            ...
            if result is not None:
                # Handle exponential backoff for 429
                sleep_time = self.DEFAULT_TIMEOUT
                while result.status_code == 429 and sleep_time < self.MAXIMUM_SLEEP:
                    print(f"Received a 429 response. Waiting for {sleep_time} seconds")
